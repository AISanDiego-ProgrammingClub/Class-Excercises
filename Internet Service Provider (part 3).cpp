...
{	
	...
	do
	{
		cout<<"Type the first 3 letters of the month you used your service\n"
			"(lower case only)\n";
		cin>>month;
		system("cls");
	}
	while(month!="jan"&&month!="feb"&&month!="mar"&&month!="apr"&&month!="may"&&month!="jun"&&month!="jul"&&month!="aug"&&month!="sep"&&month!="oct"&&month!="nov"&&month!="dec");
